...
import LaptopCard from "../../components/ShopProductCards/LaptopCard";
import FilterSidebar from "../../components/FilterSidebar";
import SeasonalLaptopData from "../../data/SeasonalLaptopData";
import "../../style/Navbar.css";

const LaptopList = () => {
  const [products] = useState(SeasonalLaptopData);
