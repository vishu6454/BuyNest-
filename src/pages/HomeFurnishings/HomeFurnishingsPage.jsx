...
const HomeFurnishingsPage = () => {
  ...
  useEffect(() => {
    const foundProduct = SeasonalHomeFurnishingsData.find(
  ...
  const handleCheckoutProcess = () => {
    ...
    if (!currentUser) {
      navigate("/Sign", {
        state: { highlightLogin: true, from: `/home-furnishings/product/${id}` },
      });
      return;
    }
    handleAddToCart();
...
export default HomeFurnishingsPage;