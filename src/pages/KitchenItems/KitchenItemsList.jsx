...
import KitchenItemCard from "../../components/ShopProductCards/KitchenItemCard";
import FilterSidebar from "../../components/FilterSidebar";
import SeasonalKitchenItemsData from "../../data/seasonalKitchenItemsData";
import "../../style/Navbar.css";

const KitchenItemsList = () => {
  const [products] = useState(SeasonalKitchenItemsData);
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <KitchenItemCard product={product} />
                </motion.div>
              ))
            ) : (
...
export default KitchenItemsList;