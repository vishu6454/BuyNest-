// src/pages/Nutrition/NutritionList.js
import { useState, useMemo } from "react";
import { motion } from "framer-motion";
import NutritionCard from "../../components/ShopProductCards/NutritionCard";
import FilterSidebar from "../../components/FilterSidebar";
import NutritionData from "../../data/nutritionData";
import "../../style/Navbar.css";

const NutritionList = () => {
  const [products] = useState(NutritionData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Nutrition Products</h1>
