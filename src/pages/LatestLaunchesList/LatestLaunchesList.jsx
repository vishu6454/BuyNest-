// LatestLaunchesList.jsx
import { useState, useMemo } from "react";
import { motion } from "framer-motion";
import LatestLaunchesCard from "../../components/ShopProductCards/LatestLaunchesCard";
import FilterSidebar from "../../components/FilterSidebar";
import LatestLaunchesData from "../../data/latestLaunchesData";
import "../../style/Navbar.css";

const LatestLaunchesList = () => {
  const [products] = useState(LatestLaunchesData);
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <LatestLaunchesCard product={product} />
                </motion.div>
              ))
            ) : (
...
export default LatestLaunchesList;