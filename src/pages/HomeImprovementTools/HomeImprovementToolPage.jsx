...
const HomeImprovementToolPage = () => {
  ...
  useEffect(() => {
    const foundProduct = SeasonalHomeImprovementToolsData.find(
  ...
  const handleCheckoutProcess = () => {
    ...
    if (!currentUser) {
      navigate("/Sign", {
        state: { highlightLogin: true, from: `/home-improvement-tools/product/${id}` },
      });
      return;
    }
    handleAddToCart();
...
export default HomeImprovementToolPage;