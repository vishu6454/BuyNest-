...
import BabyCareCard from "../../components/ShopProductCards/BabyCareCard";
import FilterSidebar from "../../components/FilterSidebar";
import BabyCareData from "../../data/babyCareData";
import "../../style/Navbar.css";

const BabyCareList = () => {
  const [products] = useState(BabyCareData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Baby Care Products</h1>
