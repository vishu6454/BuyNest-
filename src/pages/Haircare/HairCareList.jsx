...
import HairCareCard from "../../components/ShopProductCards/HairCareCard";
import FilterSidebar from "../../components/FilterSidebar";
import hairCareData from "../../data/hairCareData";
import "../../style/Navbar.css";

const HairCareList = () => {
  const [products] = useState(hairCareData);
