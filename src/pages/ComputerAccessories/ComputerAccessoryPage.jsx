...
const ComputerAccessoryPage = () => {
  ...
  useEffect(() => {
    const foundProduct = ComputerAccessoriesData.find(
  ...
  const handleCheckoutProcess = () => {
    ...
    if (!currentUser) {
      navigate("/Sign", {
        state: { highlightLogin: true, from: `/computer-accessories/product/${id}` },
      });
      return;
    }
    handleAddToCart();
...
export default ComputerAccessoryPage;