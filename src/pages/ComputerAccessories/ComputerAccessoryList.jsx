// ComputerAccessoryList.jsx
import { useState, useMemo } from "react";
import { motion } from "framer-motion";
import ComputerAccessoryCard from "../../components/ShopProductCards/ComputerAccessoryCard";
import FilterSidebar from "../../components/FilterSidebar";
import ComputerAccessoriesData from "../../data/computerAccessoriesData";
import "../../style/Navbar.css";

const ComputerAccessoryList = () => {
  const [products] = useState(ComputerAccessoriesData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Computer Accessories</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <ComputerAccessoryCard product={product} />
                </motion.div>
              ))
            ) : (
...
export default ComputerAccessoryList;