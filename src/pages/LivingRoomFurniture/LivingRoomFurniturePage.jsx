...
const LivingRoomFurniturePage = () => {
  ...
  useEffect(() => {
    const foundProduct = LivingRoomFurnitureData.find(
  ...
  const handleCheckoutProcess = () => {
    ...
    if (!currentUser) {
      navigate("/Sign", {
        state: { highlightLogin: true, from: `/living-room-furniture/product/${id}` },
      });
      return;
    }
    handleAddToCart();
...
export default LivingRoomFurniturePage;