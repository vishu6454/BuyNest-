// RefrigeratorList.jsx
import { useState, useMemo } from "react";
import { motion } from "framer-motion";
import RefrigeratorCard from "../../components/ShopProductCards/RefrigeratorCard";
import FilterSidebar from "../../components/FilterSidebar";
import RefrigeratorsData from "../../data/refrigeratorsData";
import "../../style/Navbar.css";

const RefrigeratorList = () => {
  const [products] = useState(RefrigeratorsData);
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <RefrigeratorCard product={product} />
                </motion.div>
              ))
            ) : (
