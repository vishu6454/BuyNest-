...
import AirconditionerCard from "../../components/ShopProductCards/AirconditionerCard";
import FilterSidebar from "../../components/FilterSidebar";
import AirConditionersData from "../../data/airConditionersData";
import "../../style/Navbar.css";

const AirconditionerList = () => {
  const [products] = useState(AirConditionersData);
  const [sortOption, setSortOption] = useState("featured");
  const [filters, setFilters] = useState({
    category: [],
    brand: [],
    size: [],
    priceRange: [0, 100000], // Increased range for testing
    rating: 0,
  });
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Air Conditioner</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <AirconditionerCard product={product} />
                </motion.div>
              ))
            ) : (
...
export default AirconditionerList;
