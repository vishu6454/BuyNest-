...
import FragranceCard from "../../components/ShopProductCards/FragranceCard";
import FilterSidebar from "../../components/FilterSidebar";
import FragranceData from "../../data/FragranceData";
import "../../style/Navbar.css";

const FragranceList = () => {
  const [products] = useState(FragranceData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Fragrances</h1>
