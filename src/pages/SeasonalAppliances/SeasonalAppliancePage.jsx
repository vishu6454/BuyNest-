...
const SeasonalAppliancePage = () => {
  ...
  useEffect(() => {
    const foundProduct = SeasonalAppliancesData.find(
  ...
  const handleCheckoutProcess = () => {
    ...
    if (!currentUser) {
      navigate("/Sign", {
        state: { highlightLogin: true, from: `/seasonal-appliances/product/${id}` },
      });
      return;
    }
    handleAddToCart();
...
export default SeasonalAppliancePage;