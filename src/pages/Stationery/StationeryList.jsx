...
import StationeryCard from "../../components/ShopProductCards/StationeryCard";
import FilterSidebar from "../../components/FilterSidebar";
import StationeryData from "../../data/stationeryData";
import "../../style/Navbar.css";

const StationeryList = () => {
  const [products] = useState(StationeryData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Stationery & School Supplies</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <StationeryCard product={product} />
                </motion.div>
              ))
            ) : (
