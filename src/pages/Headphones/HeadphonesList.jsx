...
import HeadphonesCard from "../../components/ShopProductCards/HeadphonesCard";
import FilterSidebar from "../../components/FilterSidebar";
import HeadphonesData from "../../data/headphonesData";
import "../../style/Navbar.css";

const HeadphonesList = () => {
  const [products] = useState(HeadphonesData);
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <main className="w-full md:w-3/4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
            <h1 className="text-2xl font-bold text-gray-900">Headphones & Speakers</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                ...
                >
                  <HeadphonesCard product={product} />
                </motion.div>
              ))
            ) : (
